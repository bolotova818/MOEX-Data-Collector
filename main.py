...
needed_date = select(func.max(PriceHistory.trade_date))
...
response = requests.get(
    "https://iss.moex.com/iss/history/engines/stock/markets/index/securities/IMOEX.json", params=params
)
